use herculaneum_mls_cubecl::{
    ...
    MLS_cubecl_last_call_ok, MLS_cubecl_last_error, MLS_cubecl_preflight,
    MLS_cubecl_project_with_arena, MLS_project_verts,
};
use std::ffi::CStr;

#[test]
fn selected_backend_passes_numerical_preflight() {
    assert_eq!(MLS_cubecl_preflight(), 1, "{}", unsafe {
...
fn explicit_arena_api_projects_a_plane() {
    ...
    assert_eq!(MLS_cubecl_last_call_ok(), 1);
