...
The single Rust/CubeCL source compiles to AMD (HIP), NVIDIA (CUDA), or WGPU via the
`cubecl-hip` / `cubecl-cuda` features. Full validation + reproducible harnesses:
<https://github.com/altommo/scrollfiesta-mls-cubecl>.
