...
This document covers the **AMD/HIP** path. The **NVIDIA/CUDA** path — including direct
element-wise parity against pscamillo's production CUDA `MLS_project_verts` — is in
[`CUDA_VALIDATION.md`](CUDA_VALIDATION.md).
